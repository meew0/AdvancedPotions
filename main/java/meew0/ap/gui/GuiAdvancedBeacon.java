 ...
 * Mostly copied from GuiBeacon, I couldn't inherit because bugs.
 */
public class GuiAdvancedBeacon extends GuiContainer {
    ...
    private TileEntityAdvancedBeacon tileBeacon;
    //private GuiAdvancedBeacon.ConfirmButton beaconConfirmButton;
    ...
    public void initGui() {
        super.initGui();
        /*this.buttonList.add(this.beaconConfirmButton = new GuiAdvancedBeacon.ConfirmButton(-1, this.guiLeft + 164, this.guiTop + 107));
        this.buttonList.add(new GuiAdvancedBeacon.CancelButton(-2, this.guiLeft + 190, this.guiTop + 107));
    ...
    public void updateScreen() {
        ...
        /*if (this.buttonsNotDrawn && this.tileBeacon.getLevels() >= 0)
        {
            ...
            int l;
            int i1;
            GuiAdvancedBeacon.PowerButton powerbutton;
            ...
            for (int i = 0; i <= 2; ++i)
            {
                ...
                for (l = 0; l < j; ++l)
                {
                    ...
                    powerbutton = new GuiAdvancedBeacon.PowerButton(i << 8 | i1, this.guiLeft + 76 + l * 24 - k / 2, this.guiTop + 22 + i * 25, i1, i);
            ...
            for (l = 0; l < j - 1; ++l)
            {
                ...
                powerbutton = new GuiAdvancedBeacon.PowerButton(b0 << 8 | i1, this.guiLeft + 167 + l * 24 - k / 2, this.guiTop + 47, i1, b0);
                this.buttonList.add(powerbutton);
            ...
            {
                GuiAdvancedBeacon.PowerButton powerbutton1 = new GuiAdvancedBeacon.PowerButton(b0 << 8 | this.tileBeacon.getPrimaryEffect(), this.guiLeft + 167 + (j - 1) * 24 - k / 2, this.guiTop + 47, this.tileBeacon.getPrimaryEffect(), b0);
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        /*else if (button instanceof GuiAdvancedBeacon.PowerButton)
        {
            if (((GuiAdvancedBeacon.PowerButton) button).func_146141_c())
            {
                return;
            }
...
/*        while (iterator.hasNext())
    ...
    static class Button extends GuiButton
    {
        ...
        /*public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
        {
            if (this.visible)
            {
                p_146112_1_.getTextureManager().bindTexture(GuiAdvancedBeacon.beaconGuiTextures);
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                ...
                if (!GuiAdvancedBeacon.beaconGuiTextures.equals(this.field_146145_o))
                {
    ...
    @SideOnly(Side.CLIENT)
    class CancelButton extends GuiAdvancedBeacon.Button
    {
        private static final String __OBFID = "CL_00000740";

        public CancelButton(int par2, int par3, int par4)
        {
            super(par2, par3, par4, GuiAdvancedBeacon.beaconGuiTextures, 112, 220);
        }

        public void func_146111_b(int p_146111_1_, int p_146111_2_)
        {
            GuiAdvancedBeacon.this.drawCreativeTabHoveringText(I18n.format("gui.cancel", new Object[0]), p_146111_1_, p_146111_2_);
        }
    }

    @SideOnly(Side.CLIENT)
    class ConfirmButton extends GuiAdvancedBeacon.Button
    {
        private static final String __OBFID = "CL_00000741";

        public ConfirmButton(int par2, int par3, int par4)
        {
            super(par2, par3, par4, GuiAdvancedBeacon.beaconGuiTextures, 90, 220);
        }

        public void func_146111_b(int p_146111_1_, int p_146111_2_)
        {
            GuiAdvancedBeacon.this.drawCreativeTabHoveringText(I18n.format("gui.done", new Object[0]), p_146111_1_, p_146111_2_);
        }
    }*/

/*    @SideOnly(Side.CLIENT)
    class PowerButton extends GuiAdvancedBeacon.Button
    {
        ...
        public void func_146111_b(int p_146111_1_, int p_146111_2_)
        {
            ...
            GuiAdvancedBeacon.this.drawCreativeTabHoveringText(s, p_146111_1_, p_146111_2_);
        }
    }*/
}
