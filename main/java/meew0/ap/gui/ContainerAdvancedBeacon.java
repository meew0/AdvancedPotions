...
public class ContainerAdvancedBeacon extends Container {
    ...
    public ContainerAdvancedBeacon(InventoryPlayer par1InventoryPlayer, TileEntityAdvancedBeacon par2TileEntityBeacon) {
        beaconSlot = new BeaconSlot(par2TileEntityBeacon, 0, 136, 110);
        tileBeacon = par2TileEntityBeacon;
        addSlotToContainer(beaconSlot);

        potionSlot = new PotionSlot(par2TileEntityBeacon, 1, 50, 50);
        addSlotToContainer(potionSlot);
    ...
    class PotionSlot extends Slot {
        ...
        @Override
        public boolean isItemValid(ItemStack par1ItemStack) {
            return par1ItemStack.getItem() instanceof ItemAdvancedPotion;
        }
