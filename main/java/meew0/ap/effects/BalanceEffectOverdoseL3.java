 ...
 */
public class BalanceEffectOverdoseL3 implements IBalanceEffect {
    @Override
    ...
    public void doEffect(ItemStack potionStack, World world, EntityLivingBase entity) {
        entity.addPotionEffect(new PotionEffect(Potion.poison.getId(), 400, 1));
    }

    @Override
    public String getUnlocalizedEffectMessage() {
        return "ap.balanceMessage.overdose.3.name";
    }
}
